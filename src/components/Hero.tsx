        ...
        <div>
          ...
          <FadeUp delay={1.3}>
            <div className="mt-8 flex items-center gap-5">
              <a href="https://linkedin.com/in/sahilbajaj" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-[#BF80FF] transition-colors duration-200 cursor-pointer" aria-label="LinkedIn">
